    ...
    if (offer != undefined && offer != null && offer == "true" && errorTouchID != true) {
        if(!_.has(user, "touchID") || user.touchID == false) {
            ...
            if(AWBE.Components.TouchID.disponivel()) {
                ...
                AWBE.sessionStorage.setItem('chamarAvaliarApp','true');
                console.log("chamarAvaliapApp true");
                //updateConta(false);
            }
        } else {
            AWBE.sessionStorage.setItem('chamarAvaliarApp','true');
...
function touchIDSuccess() {
    ...
    console.log('chamando mostrarAvaliarApp() linha 82');
    mostrarAvaliarApp();
}
...
function touchIDError() {
    ...
    console.log('chamando mostrarAvaliarApp() linha 96');
    mostrarAvaliarApp();
}
