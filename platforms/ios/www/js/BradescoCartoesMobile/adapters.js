...
BradescoCartoesMobile.adapters = {
	...
	*/
	...
	pagamentoEnviarEmail: {
		...
		parametros: ['pagina','contaCartao','numCartao', 'isBradescard', 'perfilCartao','perfilCliente','bandeira', 'bradescard', 'cpf', 'nomeProduto', 'finalProduto', 'nomeEmbosso']
	},
	...
	extratoCartaoSemLancamentos: {
		url: '/extrato/recuperarExtratoSemLancamentos',
		parametros: ['sessao', 'contaCartao', 'cartao', 'dataVencimento', 'dataVencimentoAtual', 'bcard', 'tipo', 'titularidade', 'formaPagamento', 'cpf', 'tela']
	},
	 ...
	 */
	extratoEnviarEmail: {
		url: '/extrato/enviarEmailComCotacaoDolar',
	...
	habilitarDesabilitarFaturaDigital: {
		...
		parametros: ['cpf','numCartao','numContaCartao','nomeEmbosso','flagFaturaDigital','bandeira','perfilCliente','codigoPerfilCartao','isBradescard',
			'codigoMotivoCancelamento','codigoCanal','email']
	},
	...
	resumoExtratoAberto: {
		url: '/taxasfidelity/resumoExtratoAberto',
		parametros: ['contaCartao','numCartao','dataVencimento']
	},
	consultarDadosUsuarioIdentificado:{
		url: '/cadastro/consultarDadosUsuario'
	},
	recuperarDadosLancamentoExtrato:{
		url: '/extrato/recuperarDadosLancamentoExtrato',
		parametros: ['listNumeroCartao','bcard','contaCartao','dataDDMMYYYY']
	},
	consultaContaElegParcelamentoFatura: {
		url: '/parcelamentofatura/consultaContaElegParcelamentoFatura',
		parametros: ['agencia','conta']
	},
	consultarElegibilidadeParcelamentoFidelity: {
		url: '/parcelamentofatura/consultarElegibilidadeParcelamentoFidelity',
		parametros: ['agencia','conta']
	},
	consultarDescricaoParametrosPortal: {
		url: '/parcelamentofatura/consultarDescricaoParametrosPortal',
		parametros: ['nomeIdentificacaoParam']
	},
	consultaSimulacaoExistParcelamentoFatura: {
		url: '/parcelamentofatura/consultaSimulacaoExistParcelamentoFatura',
		parametros: ['pagina','contaCartao','numCartao', 'isBradescard', 'perfilCartao','perfilCliente','bandeira']
	},
	consultarDetalhesParcelamentoBradescard: {
		url: '/parcelamentofatura/consultarDetalhesParcelamentoBradescard',
		parametros: ['pagina','contaCartao','numCartao','isBradescard','perfilCartao','perfilCliente','bandeira','org']
	},
	ativarParcelamentoFaturaBradescard: {
		url: '/parcelamentofatura/ativarParcelamentoFaturaBradescard',
		parametros: ['pagina','contaCartao','numCartao','isBradescard','perfilCartao','perfilCliente','bandeira','org','qtdParcelas']
	},
	novaSimulacaoParcelamentoFatura: {
		url: '/parcelamentofatura/novaSimulacaoParcelamentoFatura',
		parametros: ['pagina','contaCartao','numCartao', 'isBradescard', 'perfilCartao','perfilCliente','bandeira','valorAdesao','qtdParcelas']
	},
	incluirNovaSimulacaoParcelamentoFatura: {
		url: '/parcelamentofatura/incluirNovaSimulacaoParcelamentoFatura',
		parametros: ['pagina','contaCartao','numCartao', 'isBradescard', 'perfilCartao','perfilCliente','bandeira','processadora','valorAdesao','qtdParcelas','statusSimulacao']
	},
	getCurrentTimeFromServer: {
		url: '/parcelamentofatura/horaNoServidor'
	},
	inserirRastreabilidadeParcelamentoFatura: {
		url: '/parcelamentofatura/inserirRastreabilidadeParcelamentoFatura'
	},
	recuperarDadosLancamentoExtratoComMoeda:{
		url: '/extrato/recuperarDadosLancamentoExtratoComMoeda',
		parametros: ['listNumeroCartao','bcard','contaCartao','dataDDMMYYYY']
	},
	recuperarCotacaoDolarPorData:{
		url: '/cotacao/logada/recupera',
		parametros: ['dtIni','dtFim']
	},
	enviarEmailComCotacaoDolar: {
		url: '/extrato/enviarEmailComCotacaoDolar',
		parametros: ['sessao', 'contaCartao', 'cartao', 'dataVencimento', 'dataVencimentoAtual', 'bcard', 'tipo', 'titularidade', 'nomeProduto', 'finalProduto', 'identificador', 'nomeEmbosso']
	},
	consultaElegParcelamentoFaturaSimplificado: {
		url: '/parcelamentofatura/consultaElegParcelamentoFaturaSimplificado',
		parametros:  [ 'org', 'contaCartao', 'cardOwnership', 'isRegistrationComplete' ]
	}
