...
BradescoCartoesMobile.routes = {
    ...
    extrato: {
        controller: BradescoCartoesMobile.controllers.ExtratoController.indexExtrato,
        views: {
    ...
    extratoEnviarEmail: {
        controller: BradescoCartoesMobile.controllers.ExtratoController.enviarEmail,
        requiresAuthentication: false
    },
    ...
    resumoGastos: {
        controller: BradescoCartoesMobile.controllers.resumoGastosController.index,
        views: {
            resumoGastos: "extrato/resumoGastos/resumoGastos",
            personalizarCartoes: "route:personalizarCartoes"
        },
        analytics: {
...
//        back: ['home/homeLogada', 'extrato/extrato']
    ...
    pagamento: {
        controller: BradescoCartoesMobile.PagamentoController.detalhesPagamento,
        requiresAuthentication: false,
        views: {
    ...
    pagarPeloAplicativo: {
        controller: BradescoCartoesMobile.PagamentoController.pagarPeloAplicativoController,
        views: {},
        requiresAuthentication: false
    },
    ajustes: {
    ...
    dadosPessoais: {
        controller: BradescoCartoesMobile.PerfilEditarController.dadosPessoais,
        views: {
    ...
    valorEntradaParcelamentoFatura: {
    	controller: BradescoCartoesMobile.ParcelamentoFatura.fidelity.valorEntrada,
        views: {
            valorEntrada: "parcelamentofatura/valorEntrada"
        },
        requiresAuthentication: false,
    },
    valorEntradaBradescardParcelamentoFatura: {
    	controller: BradescoCartoesMobile.ParcelamentoFatura.bradescard.valorEntrada,
        views: {
            valorEntrada: "parcelamentofatura/valorEntradaBradescard"
        },
        requiresAuthentication: false,
    },
    resumoContratoParcelamentoFatura: {
        controller: BradescoCartoesMobile.ParcelamentoFatura.ControllerGeneric.renderViewResumoContrato,
        views: {
            resumoContrato: "parcelamentofatura/resumoContrato"
        },
        requiresAuthentication: false,
    },
    contratarParcelamento: {
    	controller: BradescoCartoesMobile.ParcelamentoFatura.ControllerGeneric.contratarParcelamento,
        views: {
            contratarParcelamento: "parcelamentofatura/contratarParcelamento"
        },
        requiresAuthentication: false,
    },
    realizarParcelamentoFatura: {
        controller: BradescoCartoesMobile.ParcelamentoFatura.ControllerGeneric.realizarParcelamentoFatura,
        views: {
            homeLogada :"route:pagamento"
        },
        requiresAuthentication: false,
    },
    ...
    taxasTarifasFidelity: {
        requiresAuthentication: false,
    	controller: BradescoCartoesMobile.controllers.taxaseTarifasFidelityController.listagem,
    	views: {
            error: "taxasTarifasFidelity/error",
            listagemTarifas: "taxasTarifasFidelity/listagem",
        },
        back: ['extrato/extrato'],
    },
    ...
    cotacaoDolar: {   
    	requiresAuthentication: false,
    	controller: BradescoCartoesMobile.cotacaoDolarController.loadCotacaoDolarView,
    	views: {
    		cotacaoDolar: "extrato/cotacao/cotacaoDolar"
        },
        back: ['extrato/extrato'],
    },
    renegociacao: {
        requiresAuthentication: false,
        controller: BradescoCartoesMobile.controllers.renegociacaoController,
        views: {
            renegociacao: "renegociacao/renegociacao",
        },
        analytics: {
            pageName: "renegociacao/renegociacao"
        },
        back: ['home/homeLogada']
    },
};