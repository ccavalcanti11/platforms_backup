...
function exibirQRCamera() {
	...
	if (!window.exibiuErroPermissaoCamera) { // exibe popup apenas uma vez
		window.exibiuErroPermissaoCamera = true;
...
/*  // EventListener sado para testes com a funcionalidade de Avaliação do Aplicativo e não é mais necessário. 
	window.addEventListener("hashchange", doThisWhenTheHashChanges, false);

	function doThisWhenTheHashChanges(event) {

	   console.log("____________________________------------------------------------------------------------------------------_______________________________________");
//	   AWBE.util.openPopup('popupAvaliarApp');
	}
*/
});
