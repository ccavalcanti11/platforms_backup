...
public abstract class AbstractCalendarAccessor {
  ...
  private Event[] fetchEventInstances(String eventId, String title, String location, String notes, long startFrom, long startTo) {
    ...
    if (cursor.moveToFirst()) {
      ...
      int titleCol = cursor.getColumnIndex(this.getKey(KeyIndex.EVENTS_SUMMARY));
      ...
      do {
        ...
        instances[i].title = cursor.getString(titleCol);
  ...
  public String createCalendar(String calendarName, String calendarColor) {
    try {
      ...
      cv.put(CalendarContract.Calendars.ACCOUNT_NAME, "BradescoCartaoesMobile");
      ...
      cv.put(CalendarContract.Calendars.OWNER_ACCOUNT, "BradescoCartaoesMobile");
      ...
      calUri = calUri.buildUpon()
          ...
          .appendQueryParameter(CalendarContract.Calendars.ACCOUNT_NAME, "BradescoCartaoesMobile")
