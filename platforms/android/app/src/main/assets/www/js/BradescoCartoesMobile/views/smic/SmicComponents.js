...
function initSmicPrivate() {
    initSmic('com.bradesco.appprivate','br.com.bradesco.integrador.MainActivity');
}
                ...
                SmicHelper.registerForEvents( function (e) {
                    ...
                    switch (e.type) {
                        case Scopus.SMICCDV.RequestType.TRUST:
                            ...
                            smicUtils.mustCallPermissionPopup();
                            smicUtils.setEventType(e.type);
...
function injecaoCustomConfirm(nomeAppSolicitou) {
        ...
        if(nomeAppSolicitou.contains('com.bradesco')) 
