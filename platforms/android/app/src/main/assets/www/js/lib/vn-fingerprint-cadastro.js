...
var FingerprintCadastro = {
		...
		if ((offerL != undefined && offerL != null && offerL == "true") || (offerS != undefined && offerS != null && offerS == "true")) {
			...
			if (!_.has(user, "fingerprint") || user.fingerprint == false) {
				...
				try {
					...
					console.log("Exception Fingerprint: No fingerprint plugin.");
				}
			} else {
				console.log('chamando mostrarAvaliarApp() linha 65');
				mostrarAvaliarApp();
			}
		} else {
			console.log('chamando mostrarAvaliarApp() linha 69');
			mostrarAvaliarApp();
			AWBE.sessionStorage.setItem('autorizando', false);
		}
	},
	...
	isAvailableSuccess: function (result) {
		...
		if (result.isAvailable && result.hasEnrolledFingerprints) {
			...
			AWBE.sessionStorage.setItem('autorizando', false);
			console.log('chamando mostrarAvaliarApp() linha 110');
			mostrarAvaliarApp();
		}
	},
	/**
	...
	isAvailableError: function (error) {
		...
		console.log('chamando mostrarAvaliarApp() linha 122');
		mostrarAvaliarApp();
	},
	/**
	...
	loginSuccess: function (result) {
		...
		console.log('chamando mostrarAvaliarApp() linha 138');
		mostrarAvaliarApp();
	},
	/**
	...
	loginFail: function (error) {
		...
		console.log('chamando mostrarAvaliarApp() linha 172');
		mostrarAvaliarApp();
	},
